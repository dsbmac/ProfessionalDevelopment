...
class SimpleVirus(object):
    ...
    def __init__(self, maxBirthProb, clearProb):
        ...
        """
        self.maxBirthProb = float(random.random())
        self.clearProb = float(random.random())
    ...
    def doesClear(self):
        ...
        return float(random.random()) <= self.clearProb
    ...
    def reproduce(self, popDensity):
        ...
        if random.random() <= self.maxBirthProb:
            return SimpleVirus(self.maxBirthProb, clearProb)
        else:
...
class SimplePatient(object):
    ...
    def update(self):
        ...
        for v in self.viruses:
            ...
            try:
                newVirus = reproduce(self.popDensity)
...
def simulationWithoutDrug():
    ...
    for i in range(timeSteps):
        ...
        result.append(viruses)

    return result

def displayWDSim(simResults)

    pylab.plot(result, 'r', label = 'Simulation')
