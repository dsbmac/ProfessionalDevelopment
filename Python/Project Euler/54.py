...
def winner(line):
    hands = make_player_hands(line)
    hand1 = hands[0]
    hand2 = hands[1]
    prop1 = seperate_properties(hand1)
    rank1 = prop1[0]
    suit1 = prop1[1]
    prop2 = seperate_properties(hand2)
    rank2 = prop2[0]    
    suit2 = prop2[1]

    p1Score = hand_score(rank1, suit1)
    p2Score = hand_score(rank2, suit2)
...
#print winner("3H 7H 6S KC JS QD TD JD 2D 8D")
